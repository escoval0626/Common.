    ...
    <footer className="bg-surface py-32 px-12 md:px-32 border-t border-outline-variant/30">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-24">
        ...
        <div className="space-y-8 max-w-sm">
          ...
          <p className="text-[11px] tracking-[0.3em] uppercase leading-relaxed text-secondary font-ultra-light whitespace-pre-wrap md:whitespace-nowrap">
        ...
        <div className="flex flex-wrap gap-16 md:gap-32">
          ...
          <div className="space-y-4">
            <span className="text-[11px] tracking-[0.4em] text-zinc-400 uppercase font-ultra-light block mb-6">FOLLOW</span>
            <div className="flex gap-10">
              {['Instagram', 'note'].map((link) => (
                <a key={link} href="#" className="text-[11px] tracking-widest uppercase text-secondary hover:text-primary transition-colors font-ultra-light">
                  {link}
                </a>
              ))}
            </div>
